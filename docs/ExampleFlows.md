...
- AZ calls `GET /collection/az_id/get` to view his collection and decide what cards to sell so he can afford the packs.
...
- He then calls `POST /packs/users/misty_id/open_pack/"Paldean Fates"/1` to open his pack.
